...
def solve(idx):
    ...
    for sel_cctv in selected_cctvs:
        draw_area = []
        if sel_cctv[0] == 1:
            draw_area.extend(draw_cctv_area(sel_cctv[1], sel_cctv[2], sel_cctv[2]))
        elif sel_cctv[0] == 2:
            draw_area.extend(draw_cctv_area(sel_cctv[1], sel_cctv[2], sel_cctv[2]))
            draw_area.extend(draw_cctv_area(sel_cctv[1], sel_cctv[2], (sel_cctv[2] + 2) % 4))
        elif sel_cctv[0] == 3:
            draw_area.extend(draw_cctv_area(sel_cctv[1], sel_cctv[2], sel_cctv[2]))
            draw_area.extend(draw_cctv_area(sel_cctv[1], sel_cctv[2], (sel_cctv[2] + 1) % 4))
        elif sel_cctv[0] == 4:
            draw_area.extend(draw_cctv_area(sel_cctv[1], sel_cctv[2], sel_cctv[2]))
            draw_area.extend(draw_cctv_area(sel_cctv[1], sel_cctv[2], (sel_cctv[2] + 1) % 4))
            draw_area.extend(draw_cctv_area(sel_cctv[1], sel_cctv[2], (sel_cctv[2] + 2) % 4))
            ...
            draw_area.extend(draw_cctv_area(sel_cctv[1], sel_cctv[2], (sel_cctv[2] + 1) % 4))
            draw_area.extend(draw_cctv_area(sel_cctv[1], sel_cctv[2], (sel_cctv[2] + 2) % 4))
            draw_area.extend(draw_cctv_area(sel_cctv[1], sel_cctv[2], (sel_cctv[2] + 3) % 4))
